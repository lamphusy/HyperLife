    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mConsumed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (carb_breakfast.isEmpty()) {
                    carb_breakfast = "0";
                }
                if (carb_lunch.isEmpty()) {
                    carb_lunch = "0";
                }
                if (carb_snack.isEmpty()) {
                    carb_snack = "0";
                }
                if (carb_dinner.isEmpty()) {
                    carb_dinner = "0";
                }
                if (protein_breakfast.isEmpty()) {
                    protein_breakfast = "0";
                }
                if (protein_lunch.isEmpty()) {
                    protein_lunch = "0";
                }
                if (protein_snack.isEmpty()) {
                    protein_snack = "0";
                }
                if (protein_dinner.isEmpty()) {
                    protein_dinner = "0";
                }
                if (fat_breakfast.isEmpty()) {
                    fat_breakfast = "0";
                }
                if (fat_lunch.isEmpty()) {
                    fat_lunch = "0";
                }
                if (fat_snack.isEmpty()) {
                    fat_snack = "0";
                }
                if (fat_dinner.isEmpty()) {
                    fat_dinner = "0";
                }
